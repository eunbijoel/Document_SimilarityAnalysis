...
from src.ui.excluded_sentences_tab import (
    render_excluded_tab,
    reset_excluded_feature_session,
    merge_display_analysis,
)
...
def main():
    ...
    with tab_excluded:
        render_excluded_tab(analysis, recompute_sentence_side=recompute_sentence_side)
